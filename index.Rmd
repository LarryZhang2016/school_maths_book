...
2x = 136,
$$
from which easily we have $x=\frac{136}{2}=68$. Next, to find $y$, we can either replace 68 for $x$ in one equation to have $68+y=100$, which yields $y=32$, or this time we knock out $y$ by using the top equation to subtract the second equation
$$
2y = 64,
$$
...
2x + 2y = 4 (\#eq:ex2-3)
\end{equation}
The result of Eq. \@ref(eq:ex2-1) and Eq. \@ref(eq:ex2-3) is
$$
y=2.
$$
...
We provide two solutions for the problem. The essential spirits in the two solutions are the same---**we must firstly eliminate one unknown in order to get the other unknown.**
